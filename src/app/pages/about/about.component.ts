      ...
      <div class="max-w-7xl mx-auto">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div class="space-y-6">
            ...
            >
              Vainah Pay - платформа, предоставляющая потребителям возможность
              моментальной электронной оплаты товаров, услуг и осуществления
              денежных переводов. Через платформу «Vainah Pay» можно оплатить
              товары и услуги по более 2000 поставщикам. В процессе приема
              платежей АО «Вайнах Пэй» выступает в роли процессингового центра,
              оказывающее информационное и технологическое взаимодействие между
              поставщиком услуг и плательщиком.
            </p>
          </div>
