...
@Component({
  ...
  template: `
    <!-- Hero Section -->
    <section
      class="pt-32 pb-20 px-6 bg-gradient-to-br from-slate-50 via-white to-primary-50"
    >
            ...
            <div class="relative w-80 h-80">
              ...
              >
                <div class="text-center">
                  <div
                    class="w-24 h-24rounded-full mx-auto mb-6 flex items-center justify-center"
                  >
